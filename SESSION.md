...
**Статус:** Комитнато (3 feature commit-а на main: "Cashier screen redesign
(step 4): POS shortcut curation", "...(step 5): Tabulator cart, on-screen
keyboard, and a line-void audit log", плюс docs commit-и).
...
**Тествано:**
- Автоматични тестове: 240/240 (`python manage.py test`) — нови класове
  ...
  `LogRemovedSaleItemViewTests` (sales).
...
- Фаза 2 (касиерски редизайн) е практически завършена по оригиналния
  4-стъпков план + POS shortcuts добавката. Следващото по ROADMAP:
